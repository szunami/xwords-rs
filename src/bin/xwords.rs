...
use clap::{App, Arg};
use xwords::{crossword::Crossword, default_indexes, fill::Filler, fill::{parallel::ParallelFiller, simple::SimpleFiller, single_threaded::SingleThreadedFiller}};
...
fn main() -> Result<(), String> {
    ...
    let algorithm = matches.value_of("algorithm").expect("failed to load algorithm");
